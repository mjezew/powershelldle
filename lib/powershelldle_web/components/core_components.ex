defmodule PowerShelldleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PowerShelldleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PowerShelldleWeb.Gettext, "errors", msg, opts)
    end
  end
